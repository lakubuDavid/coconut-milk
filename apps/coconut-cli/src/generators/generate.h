...
namespace coconut::generator {
  ...
  int runGenerateWatch(
      const std::string& cmdRoot = "commands", const std::string& outDir = "generated"
  );
  ///
  ...
  int runGenerate(const std::string& cmdRoot = "commands", const std::string& outDir = "generated");
