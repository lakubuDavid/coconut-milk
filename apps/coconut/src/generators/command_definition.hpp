...
static std::string generateLuaBgWrapper(const std::vector<CommandDefinition>& commands,
...
static std::string generateLuaMtWrapper(const std::vector<CommandDefinition>& commands,
                                          const std::string& modulePath) {
  std::stringstream out;
  out << "-- Generated by Coconut Milk build pipeline.\n";
  out << "-- Do not edit by hand.\n";
