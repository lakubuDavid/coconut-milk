...
Result platformMessageBox(const std::string& title,
  ...
  @try {
    ...
    SEL allocInitSel = sel_registerName("alloc");
    SEL initSel = sel_registerName("init");

    id alert = ((id(*)(id, SEL))objc_msgSend)(
        ((id(*)(id, SEL))objc_msgSend)((id)alertClass, allocInitSel), initSel);
    ...
    if (kind == "question") {
      ((void(*)(id, SEL, id))objc_msgSend)(alert, addBtnSel, nsString("Yes"));
      ((void(*)(id, SEL, id))objc_msgSend)(alert, addBtnSel, nsString("No"));
    } else {
      ((void(*)(id, SEL, id))objc_msgSend)(alert, addBtnSel, nsString("OK"));
    }
...
Result platformOpenFile(const std::string& title,
  ...
  @try {
    ...
    // openPanel returns an already-initialized instance — do NOT call init
...
Result platformSaveFile(const std::string& title,
  ...
  @try {
    ...
    // savePanel returns an already-initialized instance — do NOT call init
